...
public class Solution {
	/**
	 * Author: Tristan J Frey Date: January 5, 2025
	 * 
	 * This class handles an Merge Sort algorithm in both reverse and forward order.
	 */

	/**
	 * Sorts an array using the Merge Sort algorithm in both forward and reverse
	 * order.
	 * 
	 * The method creates two copies of the input array: one sorting in forward
	 * order and one sorting in reverse order. It then calls the sort method to sort
	 * both arrays, then returns a 2D array containing the sorted arrays.
	 *
	 * @param list An array of integers to be sorted.
	 * @return arr A 2D array containing two sorted arrays: one in forward order and
	 ...
	 * 
	 * Recursive method that divides the array into smaller sub-arrays, sorts those
	 * sub-arrays, and then merges them back together in sorted order.
	 *
	 * @param array   The array to be sorted.
	 * @param forward Boolean indicating whether to sort in forward (true) or
	 *                reverse (false) order.
	 */
	public static void sort(int[] array, boolean forward) {
		...
		/**
		 * Indices i handles leftArray array indices && original array indices j handles
		 * rideArray indices
		 */
		int i = 0, j = 0;
	 ...
	 * 
	 * This method compares elements from both arrays and merges them in either
	 * forward (true) or reverse order (false).
	 *
	 * @param leftArray  The left sub-array.
	 * @param rightArray The right sub-array.
	 * @param array      The original array to be sorted.
	 * @param forward    Boolean indicating whether to merge in forward (true) or
	 *                   reverse (false) order.
	 */
	private static void sorting(int[] leftArray, int[] rightArray, int[] array, boolean forward) {
		...
		/**
		 * Indices: i handles the original array indices l handles leftArray indices r
		 * handles rightArray indices
		 */
		int i = 0, l = 0, r = 0;

		// Compare elements from left and right arrays and merge them into the original
		// array
		if (forward == true) {
			// Forward merge
